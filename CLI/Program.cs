...
namespace GoldenSparks.Cli {
    public static class Program {
        ...
        public static void Main(string[] args) {
            ...
            // If GoldenSparks_.dll is missing, a FileNotFoundException will get thrown for GoldenSparks dll
            try {
                EnableCLIMode();
        ...
        {
            Write("&eNotice: " + Colors.Strip(Server.SoftwareName) + " is obsolete, please use the Flames software instead.");
